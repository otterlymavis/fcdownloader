...
_REGISTRY: list[ExtractorCapabilities] = [
    ...
    ExtractorCapabilities(
        hosts=(
            ...
            "tistory.com", "daum.net", "tv.kakao.com", "kakao.com",
            "blog.livedoor.jp", "livedoor.blog", "livedoor.jp",
            "pixiv.net", "fanbox.cc", "t.bilibili.com", "space.bilibili.com",
            "bilibili.com/opus", "bilibili.com/read",
            ...
            "fashion-press.net", "fashionsnap.com", "wwdjapan.com", "thetv.jp",
            "mantan-web.jp", "crank-in.net", "cinematoday.jp", "eiga.com",
            "realsound.jp", "spice.eplus.jp", "jprime.jp", "smart-flash.jp",
            "flash.jp", "nikkan-gendai.com", "asagei.com", "entamenext.com",
            "girlsnews.tv", "tokyo-sports.co.jp", "hochi.news", "sponichi.co.jp",
            "nikkansports.com", "sanspo.com", "mainichi.jp", "asahi.com",
            "yomiuri.co.jp", "sankei.com", "tokyo-np.co.jp", "kyodo.co.jp",
            "47news.jp", "jiji.com", "itmedia.co.jp", "impress.co.jp",
            "watch.impress.co.jp", "news.mynavi.jp", "ascii.jp", "gigazine.net",
        ),
        has_platform_extractor=True,
        requires_referer=True,
        requires_ja_locale=True,
    ...
    ExtractorCapabilities(
        hosts=("naver.com", "tv.naver.com", "now.naver.com", "naver.me"),
        requires_referer=True,
        hls_common=True,
    ),
    ExtractorCapabilities(
        hosts=("mdpr.jp", "modelpress.jp"),
        has_platform_extractor=True,
        requires_ja_locale=True,
        hls_common=True,
        requires_referer=True,
