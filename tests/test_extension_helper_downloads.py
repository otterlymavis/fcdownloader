...
def test_url(name, url):
    ...
    is_video = any(v in name.lower() or v in url.lower() for v in ["video", "bilibili", "twitcasting", "naver", "kakao"])
    ...
    # Filter extracted items to ignore web pages/false-positives
    valid_media_items = []
