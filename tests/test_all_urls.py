...
URLS = {
    # ── Global / Social ───────────────────────────────────────────────────
    "YouTube":       ("https://www.youtube.com/watch?v=jNQXAC9IVRw", "LOGIN-GATED/SERVER IP: current YouTube playback requires fresh browser cookies when InnerTube does not expose a direct fallback"),
    "YouTube-zoo":   ("https://youtu.be/y2EJ8v-efjA?is=EI4PXDdSIXWeOMHr", "LOGIN-GATED/SERVER IP: current YouTube playback requires fresh browser cookies when InnerTube does not expose a direct fallback"),
    "TikTok":        ("https://vm.tiktok.com/ZNR7eeRqB/", "photo/gallery post"),
    "TikTok-NASA":   ("https://www.tiktok.com/@nasa.tiktok2/video/7624845650504469780", "LOGIN-GATED: current signed video URL returns HTTP 403 without a fresh TikTok browser session; audio/poster metadata may remain public"),
    "Instagram":     ("https://www.instagram.com/reel/C7VgIvhsKgR/", "LOGIN-GATED: only public images without IG cookies"),
    "Threads":       ("https://www.threads.com/@nasa/post/DZceA72Drjf", "MANUAL-SELECTION: public carousel post opens the media picker so the user can choose images; domain moved threads.net → threads.com"),
    ...
    "Dailymotion":   ("https://www.dailymotion.com/video/xa52aa8", "SERVER IP/CDN: metadata is public but the signed HLS manifest currently returns Cloudflare 403 E005"),
    ...
    "HLS manifest":  ("https://test-streams.mux.dev/issue666/playlists/cisq0gim60007xzvi505emlxx.m3u8", "small public MPEG-TS HLS fixture"),
    ...
    "Douyin":        ("https://www.douyin.com/video/6918273131559881997", "LOGIN-GATED: current Douyin playback requires a valid browser session/cookies"),
    ...
    "FC2 Video":     ("https://video.fc2.com/en/content/20121103kUan1KHs", "STALE SAMPLE: the 2012 page currently exposes only artwork/analytics assets, not its former HLS video"),
    ...
    "Naver TV":      ("https://tv.naver.com/v/101063470", "SERVER IP/TLS: current CDN URL presents a hostname-mismatched certificate to the download backend"),
    ...
    "Ameblo":        ("https://ameblo.jp/chunta-2011/entry-12970286397.html", "current article page with post media"),
    ...
    "Daily Shincho": ("https://www.dailyshincho.jp/article/2026/06031137/", "article page rather than the media-free article index"),
    ...
    "Croissant Online": ("https://croissant-online.jp/life/273608/", "article page; update article ID if 404"),
    ...
    "Crank In":      ("https://www.crank-in.net/news/186258", "article page rather than the media-free news index"),
    ...
    "Entame Next":   ("https://entamenext.com/articles/detail/46066", "current article discovered from the publisher index"),
    "GirlsNews":     ("https://girlsnews.tv/category/news", ""),
    "Girlswalker":   ("https://girlswalker.com/archives/331232/", "SERVER IP/CDN: publisher edge currently returns HTTP 503 before article HTML"),
    ...
    "Asahi":         ("https://www.asahi.com/articles/ASV6414YJV64OXIE023M.html", "current article discovered from the publisher video index"),
