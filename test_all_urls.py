...
URLS = {
    ...
    "Livedoor Blog": ("https://blog.livedoor.jp/dqnplus/", "livedoor.blogimg.jp CDN images; /archives/ article URLs are stale"),
    ...
    "Bunshun":       ("https://bunshun.jp/articles/-/89000", "ismcdn.jp images; /articles/-/<id> format; increment ID if 404"),
    ...
    "FRaU":          ("https://frau.tokyo/articles/-/167937", "res.cloudinary.com images; update article ID if 404"),
    ...
    "Asahi":         ("https://www.asahi.com/topics/", "asahicom.jp img tags in desktop-UA HTML; extractCuratedArticle picks them up"),
