...
URLS = {
    ...
    "FC2 Live":      ("https://live.fc2.com/57892267/", "OFFLINE: sample channel is not currently live"),
    ...
    "Yahoo Japan video/news": ("https://news.yahoo.co.jp/articles/aa49a2a047b9bb814c4cf9cb07222a85da7db104", "AUTH/SERVER IP: video articles expire quickly; refresh from /ranking/access/video when stale"),
    ...
    "FC2 Blog":      ("http://harinezumi2017.blog.fc2.com/blog-entry-485.html", "DNS/BROWSER-ONLY: legacy user blog host is intermittently unresolved from server fetch"),
    ...
    "Bunshun":       ("https://bunshun.jp/articles/photo/88467", "STALE SAMPLE: photo gallery URL currently returns 404"),
    ...
    "Mantan Web":    ("https://mantan-web.jp/article/20240401dog00m200001000c.html", "AUTH/SERVER IP: server fetch currently receives 403; browser/session path is used when available"),
