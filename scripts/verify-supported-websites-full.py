...
VIDEO_CASES: list[Case] = [
    ...
    Case("TVer", "video", ("https://tver.jp/episodes/epc1hdugbk",), note="geo-sensitive; passes from a Japan IP"),
    Case("ABEMA", "video", ("https://abema.tv/video/episode/194-25_s2_p1",), note="geo-sensitive; passes from a Japan IP when DRM-free"),
    ...
    Case("OpenREC", "video", ("https://www.openrec.tv/capture/l9nk2x4gn14", "https://www.openrec.tv/movie/nqz5xl5km8v"), note="movie samples may require auth; capture sample is public"),
    Case("TBS", "video", ("https://cu.tbs.co.jp/episode/11578",), expected="blocked", note="TBS FREE episode URLs expire or require current playback metadata/session"),
    Case("FOD / Fuji TV", "video", ("https://fod.fujitv.co.jp/title/5d40/5d40110076",), expected="blocked", note="sample now returns empty media JSON without a FOD session; DRM/region restrictions common"),
    Case("Yahoo Japan video/news", "video", ("https://news.yahoo.co.jp/articles/aa49a2a047b9bb814c4cf9cb07222a85da7db104",), note="video article URLs expire quickly; refresh from /ranking/access/video when stale"),
    Case("Japanese SVOD / DRM services", "video", (
    ...
    ), expected="blocked", note="Japan IP plus current logged-in browser playback required; DRM titles cannot be downloaded"),
    Case("Japanese broadcaster catch-up", "video", (
        "https://plus.nhk.jp/",
        "https://www.nhk-ondemand.jp/",
        "https://locipo.jp/",
        "https://dougaizm.mbs.jp/",
        "https://www.ytv.co.jp/mydo/",
        "https://video.tv-tokyo.co.jp/",
        "https://douga.tv-asahi.co.jp/",
        "https://ktv-smart.jp/",
        "https://vod.ntv.co.jp/",
    ), expected="blocked", note="geo-sensitive current-episode portals; use browser/extension capture after playback starts"),
